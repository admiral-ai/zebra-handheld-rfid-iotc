...
- **IOTC tenant credentials:** `tenantId`, MQTT username, MQTT password (see [How to Obtain IOTC Credentials & Tenant ID](/getting-started/prerequisites/credentials)).
...
Continue to [How to Obtain IOTC Credentials & Tenant ID](/getting-started/prerequisites/credentials) (if you are using the Zebra-hosted broker) and [How to Pair the Reader Sled with a Host](/getting-started/prerequisites/bluetooth-pairing) (Bridged sleds only). Then start [Phase 1: Prepare network and broker](/getting-started/quick-start/step-1-connect).

**Related:** 📘 [Two bootstrap tools: 123RFID Desktop and 123RFID Mobile](/foundations/introduction/bootstrap-tools) · 📕 [`get_version`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/#op-get-version) · 📕 [Firmware history](/reference/appendices/firmware-history) · 📗 [Phase 2: Bootstrap (Direct or Bridged)](/quick-start/phase-2)
