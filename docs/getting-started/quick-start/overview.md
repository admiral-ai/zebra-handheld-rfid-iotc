...
Start at [Phase 0: Prerequisites](/quick-start/phase-0) if you have not yet gathered hardware, credentials, and (Bridged only) a Bluetooth-paired host. Otherwise jump straight to [Phase 1: Prepare network and broker](/getting-started/quick-start/step-1-connect).
