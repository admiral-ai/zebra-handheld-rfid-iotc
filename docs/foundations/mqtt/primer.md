...
- For the protocol itself, the canonical reference is the MQTT 3.1.1 OASIS standard at [docs.oasis-open.org/mqtt](https://docs.oasis-open.org/mqtt/mqtt/v3.1.1/mqtt-v3.1.1.html).
