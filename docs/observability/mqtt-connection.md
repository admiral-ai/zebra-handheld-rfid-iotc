...
**Related:** 📘 [Watch your reader's pulse](/observability/heartbeat) · 📘 [How the MQTT plumbing fits together](/infrastructure/endpoints/about) · 📘 [What happens when the network drops](/fleet/retention-and-retry) · 📕 [`mqttConnEVT`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/)
