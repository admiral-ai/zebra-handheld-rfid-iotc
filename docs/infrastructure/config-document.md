...
- **[`config_events`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/#op-config-events) and event-flag configuration**, that surface has its own chapter at [Choose what the reader tells you](/observability/configure-events).
- **Bulk reconciliation across fleets**: [Keeping a fleet in sync](/fleet/bulk-management).
- **Firmware updates**: [`set_os`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/#op-set-os) is part of [Updating firmware and rebooting](/infrastructure/system-operations), not the configuration document.

**Related:** 📘 [How the MQTT plumbing fits together](/infrastructure/endpoints/about) · 📘 [Choose what the reader tells you](/observability/configure-events) · 📘 [Keeping a fleet in sync](/fleet/bulk-management) · 📕 [`get_config`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/) · 📕 [`set_config`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/)
