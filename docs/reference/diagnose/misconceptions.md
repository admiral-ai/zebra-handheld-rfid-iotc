...
#### MM-04. `reboot` returning code 1 is not a failure {#mm-04}
...
#### MM-14. `control_operation` does not configure the inventory {#mm-14}
...
#### MM-15. `set_operating_mode` cannot run during active inventory {#mm-15}
