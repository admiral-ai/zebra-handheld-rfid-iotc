...
> 📕 **REFERENCE** · Migration procedure is in [§14.5–14.7](/fleet/migration/plan), not in this FAQ.
...
**Details:** [§1.3 About IOTC V1.1 Features](/foundations/introduction/v1-1-features)

---

**Q:** Which firmware versions support V1.1?
**A:** Firmware 3.10.27 and later.
**Details:** [§20.3 Firmware Version History & Changelog](/reference/appendices/firmware-history)
