...
- `epType: SOTI`: SOTI MobiControl specialisation. The reader returns SOTI-shaped responses for [`get_wifi`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/#op-get-wifi) (see `get_wifi_response_soti.json`).
