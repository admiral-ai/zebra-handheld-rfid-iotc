    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { from: '/getting-started/prerequisites/bluetooth-pairing',      to: '/quick-start/prerequisites/bluetooth-pairing' },
          { from: '/getting-started/quick-start/step-1-connect',           to: '/quick-start/phase-1' },
          { from: '/getting-started/quick-start/step-2-discover',          to: '/quick-start/phase-2/direct' },
          { from: '/getting-started/quick-start/step-2-discover-mobile',   to: '/quick-start/phase-2/bridged' },
          ...
          { from: '/infrastructure/management/config-document',            to: '/infrastructure/config-document' },
